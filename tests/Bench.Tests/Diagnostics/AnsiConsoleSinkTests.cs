...
/// debug a live problem. The fix was measured in <c>dew_flow_mcp</c>'s sibling sink and ported here —
/// these tests are the port's proof, not a re-measurement.</para></summary>
public sealed class AnsiConsoleSinkTests
{
    ...
    private static LogEvent Event(
        ...
        new(new DateTimeOffset(2026, 8, 19, 15, 0, 0, TimeSpan.Zero),
            level,
            exception,
