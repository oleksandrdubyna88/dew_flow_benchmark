...
/// it now guards is a single <c>Write</c> of an already-finished string. Ported from the sibling sink in
/// <c>dew_flow_mcp</c>, which is where the fix was measured — the three copies are deliberate
/// duplication, and a fix in one is a prompt to carry it to the other two.</para>
/// </summary>
